...
// */
////BaseClientHandler<Object>前期最好就指定object，不要随便写类型，不然会导致进不来
//    //因为websocket比较特殊，他是由http升级上来的，所以，第一次的时候是会有一个fullHttpResponse，第二次才是websocketFrame
//    //所以会有channelRead0和channelRead1的方法的区别
//public class WebSocketClientHandlerObject extends BaseClientHandler<Object> {
//
//    //握手的状态信息
...
//    private URI uri;
//    public WebSocketClientHandlerObject(String uri){
//        try {
